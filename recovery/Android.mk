...
ifeq ($(TW_INCLUDE_EXFAT), true)
	LOCAL_CFLAGS += -DTW_INCLUDE_EXFAT
endif
ifeq ($(TW_INCLUDE_MKNTFS), true)
	LOCAL_CFLAGS += -DTW_INCLUDE_MKNTFS
endif
ifeq ($(TW_INCLUDE_NTFS_3G), true)
	LOCAL_CFLAGS += -DTW_INCLUDE_NTFS_3G
endif
ifeq ($(TW_INCLUDE_F2FS), true)
	LOCAL_CFLAGS += -DTW_INCLUDE_F2FS
endif
...
ifeq ($(TARGET_DEVICE),leo)
    ...
    include $(commands_recovery_local_path)/bootck/Android.mk
endif
